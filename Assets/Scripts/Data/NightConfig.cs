...
namespace Deadlight.Core
{
    ...
    public class NightConfig : ScriptableObject
    {
        ...
        public static NightConfig CreateNight3()
        {
            ...
            config.waveCount = 4;
            config.baseEnemyCount = 13;
            config.timeBetweenWaves = 2f;
            config.spawnInterval = 0.75f;
        ...
        public static NightConfig CreateNight4()
        {
            ...
            config.timeBetweenWaves = 1.5f;
            config.spawnInterval = 0.65f;
            config.healthMultiplier = 1.45f;
            config.damageMultiplier = 1.25f;
        ...
        public static NightConfig CreateNight5()
        {
            ...
            config.healthMultiplier = 1.6f;
            config.damageMultiplier = 1.45f;
