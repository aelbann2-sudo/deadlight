...
namespace Deadlight.Core
{
    ...
    public class NightConfig : ScriptableObject
    {
        ...
        public static NightConfig CreateNight5()
        {
            ...
            config.waveCount = 4;
            config.baseEnemyCount = 20;
            config.timeBetweenWaves = 1.6f;
            config.spawnInterval = 0.55f;
